...
def upgrade():
    ...
    with op.batch_alter_table("vehicles", schema=None) as batch_op:
        ...
        batch_op.create_unique_constraint(
            "uq_vehicle_garage_registration", ["garage_id", "registration_number"]
        )
...
def downgrade():
    ...
    with op.batch_alter_table("vehicles", schema=None) as batch_op:
        ...
        batch_op.create_foreign_key(
            batch_op.f("vehicles_customer_id_fkey"), "customers", ["customer_id"], ["id"]
        )
    ...
    with op.batch_alter_table("users", schema=None) as batch_op:
        ...
        batch_op.create_foreign_key(
            batch_op.f("users_garage_id_fkey"), "garages", ["garage_id"], ["id"]
        )
        batch_op.drop_column("updated_at")
        batch_op.drop_column("created_at")
    ...
    with op.batch_alter_table("customers", schema=None) as batch_op:
        ...
        batch_op.create_foreign_key(
            batch_op.f("customers_garage_id_fkey"), "garages", ["garage_id"], ["id"]
        )
