...
def upgrade():
    ...
    with op.batch_alter_table("garage_appointment_types", schema=None) as batch_op:
        batch_op.create_index(
            batch_op.f("ix_garage_appointment_types_garage_id"), ["garage_id"], unique=False
        )
    ...
    with op.batch_alter_table("checklist_templates", schema=None) as batch_op:
        batch_op.create_index(
            batch_op.f("ix_checklist_templates_garage_id"), ["garage_id"], unique=False
        )
    ...
    op.create_table(
        ...
        sa.Column(
            "media_required_for_statuses", postgresql.ARRAY(sa.String(length=20)), nullable=False
        ),
        sa.Column("id", sa.Uuid(), nullable=False),
        sa.Column("created_at", sa.DateTime(timezone=True), nullable=False),
        sa.Column("updated_at", sa.DateTime(timezone=True), nullable=False),
        sa.ForeignKeyConstraint(
            ["checklist_template_id"], ["checklist_templates.id"], ondelete="CASCADE"
        ),
        sa.ForeignKeyConstraint(["garage_id"], ["garages.id"], ondelete="CASCADE"),
        sa.PrimaryKeyConstraint("id"),
    )
    with op.batch_alter_table("checklist_template_items", schema=None) as batch_op:
        batch_op.create_index(
            batch_op.f("ix_checklist_template_items_checklist_template_id"),
            ["checklist_template_id"],
            unique=False,
        )
        batch_op.create_index(
            batch_op.f("ix_checklist_template_items_garage_id"), ["garage_id"], unique=False
        )
    ...
    with op.batch_alter_table("appointment_checklists", schema=None) as batch_op:
        batch_op.create_index(
            batch_op.f("ix_appointment_checklists_garage_id"), ["garage_id"], unique=False
        )
    ...
    op.create_table(
        ...
        sa.Column("updated_at", sa.DateTime(timezone=True), nullable=False),
        sa.ForeignKeyConstraint(
            ["appointment_checklist_id"], ["appointment_checklists.id"], ondelete="CASCADE"
        ),
        sa.ForeignKeyConstraint(
            ["checklist_template_item_id"], ["checklist_template_items.id"], ondelete="SET NULL"
        ),
        sa.ForeignKeyConstraint(
            ["completed_by_employee_id"], ["employees.id"], ondelete="SET NULL"
        ),
        sa.ForeignKeyConstraint(["garage_id"], ["garages.id"], ondelete="CASCADE"),
        sa.PrimaryKeyConstraint("id"),
    )
    with op.batch_alter_table("appointment_checklist_items", schema=None) as batch_op:
        batch_op.create_index(
            batch_op.f("ix_appointment_checklist_items_appointment_checklist_id"),
            ["appointment_checklist_id"],
            unique=False,
        )
        batch_op.create_index(
            batch_op.f("ix_appointment_checklist_items_garage_id"), ["garage_id"], unique=False
        )
    ...
    op.create_table(
        ...
        sa.Column("updated_at", sa.DateTime(timezone=True), nullable=False),
        sa.ForeignKeyConstraint(
            ["appointment_checklist_item_id"],
            ["appointment_checklist_items.id"],
            ondelete="CASCADE",
        ),
        sa.ForeignKeyConstraint(["garage_id"], ["garages.id"], ondelete="CASCADE"),
        sa.PrimaryKeyConstraint("id"),
    ...
    with op.batch_alter_table("checklist_item_media", schema=None) as batch_op:
        batch_op.create_index(
            batch_op.f("ix_checklist_item_media_appointment_checklist_item_id"),
            ["appointment_checklist_item_id"],
            unique=False,
        )
        batch_op.create_index(
            batch_op.f("ix_checklist_item_media_garage_id"), ["garage_id"], unique=False
        )
    ...
    with op.batch_alter_table("appointments", schema=None) as batch_op:
        ...
        batch_op.create_index(
            batch_op.f("ix_appointments_appointment_type_id"), ["appointment_type_id"], unique=False
        )
        batch_op.create_foreign_key(
            None, "garage_appointment_types", ["appointment_type_id"], ["id"]
        )
