...
def upgrade():
    ...
    op.execute(
        "ALTER TABLE employees RENAME CONSTRAINT users_garage_id_fkey TO employees_garage_id_fkey"
    )
    ...
    with op.batch_alter_table("appointments", schema=None) as batch_op:
        ...
        batch_op.create_index(
            batch_op.f("ix_appointments_employee_id"), ["employee_id"], unique=False
        )
        batch_op.create_index(
            batch_op.f("ix_appointments_customer_id"), ["customer_id"], unique=False
        )
        batch_op.create_index(
            batch_op.f("ix_appointments_vehicle_id"), ["vehicle_id"], unique=False
        )
        batch_op.create_index(
...
def downgrade():
    ...
    op.execute(
        "ALTER TABLE employees RENAME CONSTRAINT employees_garage_id_fkey TO users_garage_id_fkey"
    )
