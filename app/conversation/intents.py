...
_RULES: tuple[tuple[str, re.Pattern], ...] = (
    (
        ...
        _phrase_pattern((
            ...
            "talk to a person", "talk to someone", "talk to a human",
            "real person", "human please", "customer service", "complain",
            "complaint", "not happy", "unhappy with", "speak to a manager",
            "speak to staff", "someone from the garage",
        )),
    ),
    (
        CALLBACK_REQUEST,
        _phrase_pattern((
            "call me back", "call me please", "ring me back", "ring me please",
            "can someone call", "can you call me", "give me a call",
            "phone me back", "phone me please", "someone to call me",
        )),
    ),
    (
        CANCEL_APPOINTMENT,
        _phrase_pattern((
            "cancel my", "cancel the", "cancel appointment", "cancel booking",
            "no longer need", "don't need the appointment",
        )),
    ),
    (
        RESCHEDULE_APPOINTMENT,
        _phrase_pattern((
            ...
            "change my appointment", "change my booking", "different day",
            "different time", "push back my", "bring forward my",
        )),
    ),
    (
        MOT_EXPIRY_QUERY,
        _phrase_pattern((
            "mot due", "mot expire", "mot expiry", "when is my mot",
            "mot run out", "mot renewal",
        )),
    ),
    (
        CHECK_APPOINTMENT,
        _phrase_pattern((
            "when is my appointment", "when is my booking", "what time is my",
            "do i have anything booked", "do i have an appointment",
            "have i got an appointment", "have i got a booking",
            "check my appointment", "check my booking", "my next appointment",
        )),
    ),
    (
        APPOINTMENT_PRICE_QUERY,
        _phrase_pattern((
            "how much is", "how much does", "how much for", "what does it cost",
            "what's the cost", "what is the cost", "price of", "price for",
            "cost of", "cost for",
        )),
    ),
    (
        ...
        _phrase_pattern((
            ...
            "are you open", "when are you open", "your hours",
        )),
    ),
    (
        BUSINESS_LOCATION_QUERY,
        _phrase_pattern((
            "where are you", "your address", "what's your address",
            "your location", "how do i find you", "postcode",
        )),
    ),
    (
        APPOINTMENT_TYPE_QUERY,
        _phrase_pattern((
            ...
            "do you do mots", "do you do services", "what appointments",
        )),
    ),
    (
        CUSTOMER_DETAILS_QUERY,
        _phrase_pattern((
            "my details", "my account", "my information", "what car do i have",
            "what vehicle do i have", "my vehicles",
        )),
    ),
    (
        CHECK_AVAILABILITY,
        _phrase_pattern((
            "what slots", "what times", "what availability", "when can i come",
            "any availability", "are you free",
        )),
    ),
    (
        CREATE_BOOKING,
        _phrase_pattern((
            "book", "booking", "appointment", "mot", "service", "diagnostic",
            "diagnostics", "get my car in", "bring my car in", "bring the car in",
        )),
    ),
)
